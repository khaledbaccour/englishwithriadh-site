...
export function CtaStrip({
  ...
  return (
    <section className="py-14 sm:py-20">
      <Container>
        <div className="relative overflow-hidden rounded-[var(--radius-xl)] bg-[var(--color-ink-900)] text-white px-6 py-12 sm:px-8 sm:py-14 md:px-14 md:py-16">
          ...
          <div className="relative max-w-2xl">
            ...
            <div className="mt-7 flex flex-col sm:flex-row sm:flex-wrap gap-3">
              ...
              <ButtonLink
                ...
                variant="secondary"
                size="lg"
                className="w-full sm:w-auto justify-center bg-white/10 border-white/20 text-white hover:bg-white/20 hover:border-white/30"
              >
